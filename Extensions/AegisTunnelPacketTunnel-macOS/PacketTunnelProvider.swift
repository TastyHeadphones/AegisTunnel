    ...
    override func startTunnel(
        ...
        Task {
            do {
                ...
                let adapter = OSLogLogger(subsystem: "com.aegis.tunnel.macos.packet-tunnel", logStore: logger)
                self.loggerAdapter = adapter

                let repository = JSONProfileRepository(fileURL: profilesFileURL())
                let secretStore = KeychainSecretStore(service: "com.aegis.tunnel.macos.secrets")
